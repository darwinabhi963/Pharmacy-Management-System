...
/*
 * SIGN_UP_ADMIN_2.java
 *
 * Created on 11 Jun, 2018, 11:31:12 PM
 */
...
import javax.swing.*;
import java.sql.*;
public class SIGN_UP_ADMIN_2 extends javax.swing.JFrame {
     SIGN_UP_ADMIN_1 A=new SIGN_UP_ADMIN_1();
    /** Creates new form SIGN_UP_ADMIN_2 */
    public SIGN_UP_ADMIN_2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ADMIN CREDENTIALS");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String s=new String(jPasswordField1.getPassword());
        String s1=new String(jPasswordField2.getPassword());
            String SQL="INSERT INTO USERS VALUES(\""+jTextField1.getText()+"\",\""+s+"\","+"\"ADMIN\""+",'"+SIGN_UP_ADMIN_1.jTextField6.getText()+"','"+SIGN_UP_ADMIN_1.jTextField7.getText()+"')";
