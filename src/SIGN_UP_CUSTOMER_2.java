...
/*
 * SIGN_UP_CUSTOMER_2.java
 *
 * Created on 29 Jun, 2018, 10:44:38 PM
 */
...
public class SIGN_UP_CUSTOMER_2 extends javax.swing.JFrame {

    /** Creates new form SIGN_UP_CUSTOMER_2 */
    public SIGN_UP_CUSTOMER_2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("CUSTOMER CREDENTIALS");
 ...
 String s=new String(jPasswordField1.getPassword());
        String s1=new String(jPasswordField2.getPassword());
            String SQL="INSERT INTO USERS VALUES(\""+jTextField1.getText()+"\",\""+s+"\",\"CUSTOMER\",'"+SIGN_UP_CUSTOMER_1.jTextField6.getText()+"','"+SIGN_UP_CUSTOMER_1.jTextField7.getText()+"')";
            int n=st.executeUpdate(SQL);
            if(n==0)
                JOptionPane.showMessageDialog(null,"Error!!! Record creation Unsuccessful");

            con.close();
          if(jTextField1.getText().equals("")||s.equals("")||s1.equals("")){
            JOptionPane.showMessageDialog(null,"Mandatory Fields should not be left empty");
            new SIGN_UP_ADMIN_2().setVisible(true);} else{
            if(s.equals(s1)){
